 ...
 */
@Slf4j
public class SimpleChatServerHandler extends SimpleChannelInboundHandler<Position> { // (1)
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, Position s) throws Exception { // (4)
        Channel incoming = ctx.channel();
